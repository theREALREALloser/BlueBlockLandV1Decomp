if (fadealpha > 1)
{
    ...
    if (instance_exists(obj_player))
    {
        ...
        else if (room != obj_player2.targetRoom)
...
if (instance_exists(obj_player))
{
    with (obj_player1)
    {
        ...
        if (other.fadein == 1 && obj_player1.state == 77 && (sprite_index == spr_player_downpizzabox || sprite_index == spr_player_uppizzabox))
            state = 0;
    }
    ...
    with (obj_player2)
    {
        ...
        if (other.fadein == 1 && obj_player2.state == 77 && (sprite_index == spr_player_downpizzabox || sprite_index == spr_player_uppizzabox))
            state = 0;
    }
}
